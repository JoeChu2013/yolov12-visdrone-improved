...
def get_model_info(weights_path, yaml_path=None):
    try:
        ...
        # FPS Measurement (Simulated Inference)
...
def main():
    experiments = [
        ...
        },
        {
            ...
            "yaml": "ultralytics/cfg/models/v12/yolov12-improved.yaml", # This was the bifpn+ca config
            "components": ["✓", "✓", "-"]
        },
        {
    ...
    df.to_csv("ablation_study_p2_final.csv", index=False)
    print("\nSaved table to ablation_study_p2_final.csv")
